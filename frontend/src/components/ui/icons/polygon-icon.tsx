...
export const PolygonIcon: React.FC<IconProps> = (props) => (
  ...
  >
    <path
      ...
      opacity="0.4"
    ></path>
    <circle cx="5.997" cy="2.666" r="1.333" stroke="#2C3038" strokeLinecap="round"></circle>
    <circle cx="12.665" cy="4.666" r="1.333" stroke="#2C3038" strokeLinecap="round"></circle>
    <circle cx="13.333" cy="13.333" r="1.333" stroke="#2C3038" strokeLinecap="round"></circle>
    <circle cx="2.665" cy="11.999" r="1.333" stroke="#2C3038" strokeLinecap="round"></circle>
    <path
      stroke="#2C3038"
      strokeLinecap="round"
