...
export const APP_CONTENT = {
    ...
    footer: {
        title: 'fAIr is a platform where individuals can use an AI model for mapping in OpenStreetMap',
        copyright: {
            firstSegment: 'Images are screenshots of fAIr may be shared under a Creatives Commons Attribution-ShareAlike 4.0 International License.',
            secondSegment: 'Free and Open Source Software brought to you by the Humanitarian OpenStreetMap Team.'
        },
        socials: {
    ...
    homepage: {
        ...
        jumbotronHeadline: "AI-powered assistant that replicates your mapping samples intelligently and quickly, helping you map smarter and faster.",
        ...
        callToAction: {
            ...
            paragraph: ' Lorem ipsum dolor sit, amet consectetur adipisicing elit. Fugiat esse ipsam amet molestias impedit at nulla fuga, sed ducimus nesciunt dolore facere cum velit voluptatem provident reiciendis iure quo rerum.'
        }
    },
    pageNotFound: {
        messages: {
