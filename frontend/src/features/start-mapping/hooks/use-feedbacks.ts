...
import { createApprovedPrediction, createFeedback, TCreateApprovedPredictionPayload, TCreateFeedbackPayload } from "../api/create-feedbacks";
...
export const useCreateModelFeedback = ({
    ...
    return useMutation({
        mutationFn: (args: TCreateFeedbackPayload) =>
            createFeedback(args),
        onSuccess: (...args) => {
            onSuccess?.(...args);
        },
