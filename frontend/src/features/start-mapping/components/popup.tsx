...
import { useCreateApprovedModelPrediction, useCreateModelFeedback } from "../hooks/use-feedbacks";
...
const PredictedFeatureActionPopup = ({
    ...
    const feature = alreadyAccepted ? modelPredictions.accepted.filter(feature => feature.properties.id === featureId)[0] : alreadyRejected ? modelPredictions.rejected.filter(feature => feature.properties.id === featureId)[0] : modelPredictions.all.filter(feature => feature.properties.id === featureId)[0];
    ...
    return (
        ...
        >
            <div className="flex items-center justify-between">
                <p className="font-semibold text-body-2base">{showComment ? 'Comment' : 'Action'}</p>
                <button
