...
import { DirectoryIcon, ExternalLinkIcon, MapIcon } from "@/components/ui/icons";
...
const ModelDetailsInfo = ({ data, toggleModelFilesDialog, toggleTrainingAreaDialog }: { data: any, toggleModelFilesDialog: () => void, toggleTrainingAreaDialog: () => void, }) => (
    <>
        <ModelDetailsSection title="">
                ...
                <div className="inline-flex flex-col gap-y-4">
                    ...
                    <div className="w-full flex flex-col md:flex-row md:items-center md:justify-between gap-y-8">
                        <div className="flex flex-col gap-y-4">
                            <h1 className="font-semibold text-dark text-title-2 md:text-large-title" title={data?.name}>
                        ...
                        <div className="max-w-fit">
                            <ButtonWithIcon label="Start mapping"
                                variant="primary"
                                size="medium"
            ...
            <div className="md:self-end flex items-center gap-x-2 cursor-pointer text-primary text-body-2 md:font-semibold" onClick={toggleTrainingAreaDialog}>
        ...
        <ModelDetailsSection title="Details">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-y-9">
                <div className="flex flex-col gap-y-4">
                    ...
                    <ModelDetailItem label="Created on" value={formatDate(data?.created_at as string)} />
                    <ModelDetailItem label="Last Modified" value={formatDate(data?.last_modified as string)} />
                </div>
                <div className="col-span-1 items-start justify-between flex flex-col gap-y-4">
                    ...
                    <ButtonWithIcon label="Model Files"
