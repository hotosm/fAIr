...
const TrainingDS = React.lazy(() =>
  import("./components/Layout/TrainingDS/TrainingDS")
);
const AIModels = React.lazy(() =>
  import("./components/Layout/AIModels/AIModels")
);
...
const Feedback = React.lazy(() =>
  import("./components/Layout/Feedback/Feedback")
);
