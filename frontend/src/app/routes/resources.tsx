  ...
  return (
    <main className="static-page-layout">
      ...
      <section>
        ...
        <div className="grid grid-cols-[repeat(auto-fill,minmax(250px,1fr))] gap-x-7 gap-y-10">
  ...
  return (
    <div className="flex flex-col gap-y-8">
      <div className="relative">
        <div className="w-full h-40 border border-gray-border">
          <Image
            src={article.image}
            alt={article.title}
            className="h-full"
      ...
      <div className="flex flex-col gap-y-6">
        ...
        <p className="text-body-2base lg:text-body-2 text-gray">
          {truncateString(article.snippet, 80)}
        </p>
