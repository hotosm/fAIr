...
export const ENVS = {
  ...
  PREDICTIONS_RESULTS_POINT_FILL_COLOR: import.meta.env.VITE_PREDICTIONS_RESULTS_POINT_FILL_COLOR,
  PREDICTIONS_RESULTS_POINT_OUTLINE_COLOR: import.meta.env.VITE_PREDICTIONS_RESULTS_POINT_OUTLINE_COLOR
};
