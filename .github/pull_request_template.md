...
- 📖 Read the fAIr contributing guide: <https://github.com/hotosm/fAIr/blob/develop/CONTRIBUTING.md>
- 📖 Read the HOT Code of Conduct: <https://docs.hotosm.org/code-of-conduct>
- 👷‍♀️ Create small PRs. In most cases, this will be possible.
- ✅ Provide tests for your changes.
- 🧠 Understand all the code in this PR and be able to answer questions on it.
- 🔐 Include no secrets, credentials, or sensitive data.
